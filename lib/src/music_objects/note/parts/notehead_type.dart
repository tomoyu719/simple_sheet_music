...
enum NoteHeadType {
  ...
  const NoteHeadType(this.glyph, this.glyphBbox,
  ...
  static const _wholeBbox = Rect.fromLTRB(0.0, -0.544, 1.836, 0.548);
  static const _halfBbox = Rect.fromLTRB(0.0, -0.5, 1.18, 0.5);
  static const _blackBbox = Rect.fromLTRB(0.0, -0.5, 1.18, 0.5);
  ...
  static const _halfStemDownRootLeftTop = Offset(0.0, 0.168);

  static const _blackStemUpRootRightBottom = Offset(1.18, -0.168);
  static const _blackStemDownRootLeftTop = Offset(0.0, 0.168);
}
