...
enum CommonTimeSignatureType implements TimeSignatureMetrics {
  ...
  static const cutCommonBbox = Rect.fromLTRB(0.0, 1.444, 1.672, -1.436);
...
class TimeSignatureFractionPart {
  ...
  double get right =>
      nums.fold(0.0, (previousValue, element) => previousValue + element.width);
  double get top => nums.fold(nums.first.bbox.top,
      (previousValue, element) => max(previousValue, element.bbox.top));
  double get bottom => nums.fold(nums.first.bbox.bottom,
...
enum TimeSignatureDenominatorNum implements TimeSignatureNum {
  ...
  static const zeroBbox = Rect.fromLTRB(0.0, 2.004, 1.72, 0.0);
  static const oneBbox = Rect.fromLTRB(0.0, 2.004, 1.176, 0.0);
  static const twoBbox = Rect.fromLTRB(0.0, 2.016, 1.624, -0.028);
  static const threeBbox = Rect.fromLTRB(0.0, 1.996, 1.524, -0.004);
  static const fourBbox = Rect.fromLTRB(0.0, 2.004, 1.72, 0.0);
  static const fiveBbox = Rect.fromLTRB(0.08, 1.984, 1.532, -0.004);
  static const sixBbox = Rect.fromLTRB(0.08, 2.004, 1.656, 0.004);
  static const sevenBbox = Rect.fromLTRB(0.08, 1.996, 1.684, 0.0);
...
enum TimeSignatureNumeratorNum implements TimeSignatureNum {
  ...
  static const zeroBbox = Rect.fromLTRB(0.0, 4.004, 1.72, 2.0);
  static const oneBbox = Rect.fromLTRB(0.0, 4.004, 1.176, 2.0);
  static const twoBbox = Rect.fromLTRB(0.0, 4.016, 1.624, 1.972);
  static const threeBbox = Rect.fromLTRB(0.0, 3.996, 1.524, 1.996);
  static const fourBbox = Rect.fromLTRB(0.0, 4.004, 1.72, 2.0);
  static const fiveBbox = Rect.fromLTRB(0.08, 3.984, 1.532, 1.996);
  static const sixBbox = Rect.fromLTRB(0.08, 4.004, 1.656, 2.004);
  static const sevenBbox = Rect.fromLTRB(0.08, 3.996, 1.684, 2.0);
